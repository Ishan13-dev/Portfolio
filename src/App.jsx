    ...
    <>
      ...
      <nav className="fixed top-0 w-full bg-slate-900/95 backdrop-blur-md text-white z-50 shadow-lg">
        ...
        {mobileMenuOpen && (
          <div
            id="mobile-nav-menu"
            className="md:hidden bg-slate-900 border-t border-slate-700 px-4 py-4 space-y-2"
            role="navigation"
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 gap-8 md:gap-12 items-start md:items-center">
            <div className="text-left">
              ...
              <p className="text-base sm:text-lg leading-relaxed text-gray-700 mb-4 sm:mb-6">
                With a strong foundation from a Polytechnic Diploma in Civil
                Engineering, I bring unique problem-solving perspectives to
                software development. I specialize in building scalable,
                user-centric web applications with React and modern JavaScript
                frameworks.
              </p>

              <p className="text-base sm:text-lg leading-relaxed text-gray-700">
                Currently focused on exploring{" "}
                <span className="font-semibold text-blue-600">
                  AI/ML applications
                </span>
                , cloud technologies, and creating impactful projects that
            ...
            <div className="space-y-3 sm:space-y-4">
              {[
                ...
                {
                  title: "Tools & Tech",
                  skills: "Git, VS Code, Vite, ESLint, NPM/Yarn",
                },
                {
                  title: "AI/ML",
                  skills: "NLP Basics, Python, TensorFlow basics",
                },
              ].map((item, idx) => (
                <div
                  key={idx}
                ...
                >
                  <h4 className="font-bold text-blue-600 mb-1 text-sm sm:text-base">
                    {item.title}
                  </h4>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-5 md:gap-6">
            {[
              ...
              >
                ...
                <h3 className="text-lg sm:text-xl font-bold text-blue-600 mb-3 md:mb-4">
                  {skillGroup.category}
                </h3>
            ...
            {[
              {
                ...
                desc: "A responsive scientific calculator with history tracking, keyboard shortcuts, and dark mode built using HTML, CSS, and JavaScript. Deployed on GitHub Pages.",
                ...
                status: "Live",
                github:
                  "https://github.com/Ishan13-dev/Scientific-Calculator",
                demo:
...

              {
                ...
                desc: "Modern, responsive portfolio showcasing skills, technical expertise, and featured projects.",
              ...
              {
                title: "Mental Health NLP Analyzer",
                desc: "An AI-powered NLP application that analyzes text for mental-health-related patterns and provides an interpretable classification using machine learning.",
                tech: [
                  "Python",
                  "NLP",
                  "Machine Learning",
                ...
                github: "https://github.com/ishan13-dev",
                demo:
                  "https://ishan7031mentalhealth00nlp.streamlit.app/",
              },
            ].map((project, idx) => (
              <div
                key={idx}
              ...
              >
                ...
                <div className="p-4 sm:p-5 md:p-6">
                  <div className="flex justify-between items-start gap-3 mb-3">
                    <h3 className="text-lg sm:text-xl md:text-2xl font-bold text-slate-900 line-clamp-2">
                      {project.title}
                    </h3>
      ...
      >
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-base sm:text-lg md:text-lg text-gray-300 mb-8 sm:mb-12 leading-relaxed">
            ...
            collaborating on interesting projects. Whether you have a
            question, want to discuss technology, or need a developer for your
            next project, feel free to reach out!
          </p>
              ...
              {[
                {
                  name: "GitHub",
                  icon: "🐙",
                  url: "https://github.com/ishan13-dev",
                },
                {
                  name: "LinkedIn",
                  icon: "💼",
                ...
                },
                {
                  name: "Instagram",
                  icon: "📷",
                  url: "https://www.instagram.com/isha_13dev/",
                },
                {
                  name: "Facebook",
                  icon: "👥",
                  url: "https://www.facebook.com/profile.php?id=61559213770777",
                },
              ].map((social, idx) => (
                <a
                  key={idx}
      ...
      <footer className="bg-slate-950 text-gray-400 py-6 sm:py-8 px-4 sm:px-6 text-center border-t border-slate-800">
        <div className="max-w-6xl mx-auto">
          <p className="text-xs sm:text-sm mb-2 sm:mb-4">
            Crafted with <span className="text-red-500">❤</span> by Ishan
            Verma
          </p>

          <p className="text-xs text-gray-500">
            © 2025 Ishan Verma. Designed & Developed using React & Tailwind
            CSS.
          </p>
